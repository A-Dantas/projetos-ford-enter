...
alert(`O consumo necessário é de ${consumo_Necessario_Litros.toFixed(0)} litros`);
...
document.writeln(`<br>O menor valor pesquisado foi R$ ${menor_Valor_Pesquisado}`);
document.writeln(`<br>A média dos valores R$ ${media.toFixed(2)}`);
document.writeln(`<br>O gasto diário (ida e volta) é R$ ${gasto_Diario}`);